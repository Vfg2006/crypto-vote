...
var myAddresses = ["0x627306090abab3a6e1400e9345bc60c78a8bef57",
...
var privatesKeys = ["c87509a1c067bbde78beb793e6fa76530b6382a4c0241e5e4a9ec0a0f44dc0d3",
...
var toAddresses = ["0xb2ed8ebb091c17c21b4c6cd1ef768b66c31d15bc",
...
// for (var i = 0; i < myAddresses.length; i++) {
    ...
    var privateKey = Buffer.from(privatesKeys[0], 'hex')

    var count;
    // get transaction count, later will used as nonce
    web3js.eth.getTransactionCount(myAddresses[0]).then(function (v) {
        console.log("Count: " + v);
        count = v;
        var amount = web3js.utils.toHex(1e16);
        //creating raw transaction
        var rawTransaction = {
            "from": myAddresses[0], "gasPrice": web3js.utils.toHex(20 * 1e9), "gasLimit": web3js.utils.toHex(210000),
            "to": contractAddress, "value": "0x0", "data": contract.methods.vote(toAddresses[0]).encodeABI(),
        ...
        // contract.methods.balanceOf(myAddresses[0]).call()
